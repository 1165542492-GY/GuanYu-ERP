        ...
        static PermissionGroup[] GetPermissionDefinitions()
        {
            return new[]
            {
                ...
                new PermissionGroup { Module = "销售出库", Items = new[] {
                    ...
                    new PermissionItem { Key = "sales_outbound_accessory.view", Label = "查看赠品/随货配件" },
                    new PermissionItem { Key = "sales_outbound_accessory.add", Label = "新增赠品/随货配件" },
                    new PermissionItem { Key = "sales_outbound_accessory.edit", Label = "修改赠品/随货配件" },
                    new PermissionItem { Key = "sales_outbound_accessory.delete", Label = "删除赠品/随货配件" },
